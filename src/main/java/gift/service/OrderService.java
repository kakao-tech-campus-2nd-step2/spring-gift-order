...
public class OrderService {
    ...
    @Transactional
    public OrderResponse create(MemberResponse memberResponse, OrderRequest orderRequest) {
        wishListRepository.findByMemberAndOption(new Member(memberResponse.id()),
        ...
        Order order = orderRepository.save(
            new Order(new Member(memberResponse.id()), orderRequest));
