...
public class OrderService {
    ...
    @Transactional
    public Order createOrder(OrderServiceDto orderServiceDto) throws JsonProcessingException {
        ...
        Order order = orderRepository.save(orderServiceDto.toOrder(member, option));
        sendMessage(orderServiceDto.memberId(), OrderResponseDto.orderToOrderResponseDto(order));
        return order;
    }
    ...
    private void sendMessage(Long memberId, OrderResponseDto orderResponseDto) throws JsonProcessingException {
        ...
        TemplateObject templateObject = new TemplateObject("text", objectMapper.writeValueAsString(orderResponseDto), link, "바로 확인");
        ...
        ResponseEntity<String> response = restTemplate.exchange(URI.create(MESSAGE_URL), HttpMethod.POST, request, String.class);
